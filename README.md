...
| **调速** | 0.8x - 2.0x 连续可调 |
| **调色** | 亮度 / 对比度 / 饱和度调节 |
| **字幕添加** | 自定义内容、样式、位置、时间段；底部默认位于屏幕高度 20% 处 |
| **封面插入** | 可在最终视频开头插入自定义封面图片，时长可调 |
| **裁剪首尾** | 精确去除开头/结尾片段 |
...
| 版本 | 日期 | 更新内容 |
|------|------|---------|
| **v6.3.0** | **2026-06-22** | **新增视频封面插入功能：支持上传自定义封面图，可配置显示时长，字幕自动在封面后显示** |
| v6.2.0 | 2026-06-22 | 字幕默认位置下调至屏幕高度 20% 处；修复大 MarginV 导致字幕被推出屏幕的问题 |
