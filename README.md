...
| **抖音视频下载** | ⏸️ | 暂时关闭（需配置 Cookie） |

### 🎙️ AI 配音 (TTS)
| 功能 | 说明 |
|------|------|
| **多音色选择** | 30+ 种音色：中文（男女声+方言）、美式英语、英式英语、日语、韩语 |
| **语速调节** | 0.5x - 2.0x 自由调节 |
| **在线试听** | 生成后可立即预览效果 |
| **视频配音** | TTS 音频可直接用于替换/混合视频原声 |
| **音色预览** | 晓晓(活泼)、晓伊(温柔)、云健(新闻)、云希(年轻) 等 |

**支持音色举例：**
- 🇨🇳 中文：晓晓、晓伊、晓北(东北)、晓妮(陕西)、云健、云希、云扬
- 🇺🇸 英语：Aria, Jenny, Guy, Christopher, Libby(英式) 等 20+
- 🇯🇵 🇰🇷 日韩：七海(日语)、善熙(韩语)
...
| **BGM 混音** | 支持 MP3/M4A/WAV，可调节音量、混音或完全替换原声 |
